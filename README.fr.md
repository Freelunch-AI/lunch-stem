...
6. **Téléchargez des fichiers pdf :**
   ...
   - Pour les fichiers `.pdf.dvc`
      ...
      **Téléchargez des fichiers pdf spécifiques avec :**
      ...
      - _Note 3 :_ les autres types de fichiers (par ex., `.txt`) doivent être ouverts directement, sans utiliser la CLI lunch.
   ...
   - Pour les fichiers `.sym.txt` :
      ...
      Ouvrez simplement le fichier et naviguez vers le chemin du fichier ou dossier écrit à l'intérieur. Ce fichier ou dossier sera dans le `__Loopback`.
